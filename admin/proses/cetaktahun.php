<?php
    ...
    $pdf->Cell(0,5,'DAFTAR PESANAN TAHUN INI','0','1','C',false);
    $pdf->Ln(4);
    ...
    $pdf->Ln(5);
    $pdf->Cell(0,5,"Jumlah Pesanan tahun ini pada Cafe Papua Code : ".$count." Pesanan",'0','1','C',false);
    $pdf->Line(10, 25, 225-20, 25);
    $pdf->Ln(10);
    // $pdf->AliasNbPages('{totalPages}');
    // $pdf->Cell(0, 5, "Page " . $pdf->PageNo() . "/{totalPages}", 0, 1);
    $pdf->Output('',"Laporan Pesanan Tahun Ini.pdf");
