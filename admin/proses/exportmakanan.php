<?php
    ...
    $pdf->Cell(0,5,'DAFTAR MAKANAN','0','1','C',false);
    $pdf->Ln(4);
    $pdf->SetFont('Arial','B',7);
    $pdf->Cell(10,6,'No',1,0,'C');
    $pdf->Cell(99,6,'Nama Makanan',1,0,'C');
    ...
    $no = 0;
    $sql = mysqli_query($con, "SELECT * FROM makanan ORDER BY namamakanan");
    ...
    while ($data = mysqli_fetch_array($sql)) {
        ...
        $pdf->Cell(99,4,$data['namamakanan'],1,0,'L');
        $pdf->Cell(35,4,number_format($data['harga'],2,",","."),1,0,'R');
        $pdf->Cell(50,4,$data['image'],1,0,'C');
    }
    $pdf->Ln(5);
    $pdf->Cell(0,5,"Jumlah Makanan pada Cafe Papua Code : ".$count." Makanan",'0','1','C',false);
    $pdf->Line(10, 25, 225-20, 25);
    $pdf->Ln(10);
